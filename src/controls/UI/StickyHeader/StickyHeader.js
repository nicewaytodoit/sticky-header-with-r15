...
const buildTopStyles = (container, props) => {
  ...
  return { width, bottom: bottomOffset, position: 'absolute', margin: 'unset' };
};
...
export default class StickyHeader extends Component {
  ...
  checkPosition = () => {
    ...
    console.log("LOG", newState.styles);
    // console.log('SCROLLLL:: --->', newState, scrollRect);
  };
